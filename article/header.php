            ...
            <ul class="menu">
                ...
                <li class="menu-sport"><a href="javascript:viod(0)">SPORT</a>
                    <ul class="sub-menu sport">
                        ...
                        <li>
                            <a href="sport-news-interational.php">International</a>
                        </li>
                    </ul>
                </li>
                <li class="menu-sport"><a href="javascript:viod(0)">SOCIAL</a>
                    <ul class="sub-menu sport">
                        ...
                        <li>
                            <a href="social-news-interational.php">International</a>
                        </li>
                    </ul>
                </li>
                <li class="menu-sport"><a href="javascript:viod(0)">ENTERTAINMENT</a>
                    <ul class="sub-menu sport">
                        <li>
                            <a href="ent-news-national.php">National</a>
                        </li>
                        <li>
                            <a href="ent-news-international.php">International</a>
                        </li>
                    </ul>
                </li>
